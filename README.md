...
```groovy
implementation "com.github.tommyettinger:textratypist:2.2.12"
```
...
```groovy
implementation "com.github.tommyettinger:textratypist:2.2.12:sources"
...
If you need compatibility with libGDX 1.13.1, change `2.2.12` to `2.1.11`; it should have feature parity with `2.2.9`.
...
(Now, FreeTypist 2.2.12.0 uses TextraTypist 2.2.12, and that means it uses libGDX 1.14.0 . There's also FreeTypist
...
```groovy
implementation "com.github.tommyettinger:freetypist:2.2.12.0:sources"
```
...
Version 2.1.0 through 2.2.12 are out, and while they have fewer breaking changes, there are still several of them.
...
The quick checklist for the latest code (version 2.2.12 or newer commits from JitPack):
