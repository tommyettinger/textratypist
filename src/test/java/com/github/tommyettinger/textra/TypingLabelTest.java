...
//        text.append("Imagine the possibilities! =D");
        ...
        text.append("{NORMAL}{CLEARCOLOR}{SICK}With this library{ENDSICK} you can {SQUASH}{SIZE=150%}[_]control[_]{ENDSQUASH} {SIZE=%75}the{SIZE=150%} flow[^][SKY] [[citation needed][] of the text with");
        ...
        text.append("{RESET} You {HEARTBEAT}[#880000]can also wait[#FFFFFF]{ENDHEARTBEAT} for a {EASE=-15;2;1}second{ENDEASE}{WAIT=1} {EASE=15;8;1}{COLOR=#E6DB74}or two{CLEARCOLOR}{ENDEASE}{WAIT=2},");
