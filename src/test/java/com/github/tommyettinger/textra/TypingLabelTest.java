...
//        text.append("Imagine the possibilities! =D");
        ...
        text.append("{NORMAL}{CLEARCOLOR}{SICK}With this library{ENDSICK} you can {SIZE=150%}control {SIZE=%75}the{SIZE=150%} flow[%50][SKY] [[citation needed][] of the text with");
