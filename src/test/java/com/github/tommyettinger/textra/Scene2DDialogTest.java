...
public class Scene2DDialogTest extends ApplicationAdapter {
    ...
    public void create() {
        ...
        // okay... Dialog also seems to overlap the title and content, not just TextraDialog...
        // I must be missing something...
        dialog = new Dialog("SING ALONG, FRIENDS!", style);
...
//        System.out.println(typingLabel.workingLayout.lines());
    ...
    public static void main(String[] args){
        ...
        new Lwjgl3Application(new Scene2DDialogTest(), config);
    }
