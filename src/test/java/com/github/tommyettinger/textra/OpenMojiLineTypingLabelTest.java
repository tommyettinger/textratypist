...
public class OpenMojiLineTypingLabelTest extends ApplicationAdapter {
    Skin        skin;
    Stage       stage;
    SpriteBatch batch;
    TypingLabel label;
...
//        font.scale(2, 2);
        Font font = KnownFonts.addOpenMoji(KnownFonts.getNowAlt(), false);
...
//        updateDebugLabel();
    ...
    public void render() {
        ...
        ScreenUtils.clear(0.75f, 0.8f, 0.8f, 1);
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new OpenMojiLineTypingLabelTest(), config);
    }
}
