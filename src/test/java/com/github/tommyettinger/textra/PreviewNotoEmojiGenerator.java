...
public class PreviewNotoEmojiGenerator extends ApplicationAdapter {
    ...
    public static void main(String[] args){
        ...
        config.setTitle("Noto Emoji Preview Generator");
...
//        config.enableGLDebugOutput(true, System.out);
        ...
        new Lwjgl3Application(new PreviewNotoEmojiGenerator(), config);
    }
    ...
    public void create() {
        ...
        PixmapIO.writePNG(Gdx.files.local("out/NotoEmojiPreview.png"), pm, 2, true);
//        Gdx.app.exit();
    }
