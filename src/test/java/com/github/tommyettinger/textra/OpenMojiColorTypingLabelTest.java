...
public class OpenMojiColorTypingLabelTest extends ApplicationAdapter {
    Skin        skin;
    Stage       stage;
    SpriteBatch batch;
    TypingLabel label;
...
//        font.scale(2, 2);
        Font font = KnownFonts.addOpenMoji(KnownFonts.getNowAlt(), true);
...
//                        + " {CROWD}[#BB1100][+skull][#55AA22][+🤡]"
                ...
                +"[+⚖][~][_][+⚖][ ] testing: [_][~][%25]go[%50]go[%75]go[%100][red]go[][%125]go[%150]go[%175]go[%200]go[%225]go[%250]go![ ]\n"
...
//        updateDebugLabel();
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new OpenMojiColorTypingLabelTest(), config);
    }
}
