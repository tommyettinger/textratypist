...
public class AnimatedPreviewGenerator extends ApplicationAdapter {
    ...
    public TypingLabel createTypingLabel() {
        ...
        text.append("{SLOWER}[%140][-GRADIENT=FF70F1;light happy pink orange;-0.5;5]{EASE=-8;2;1}{SHRINK=2;5}[@Medieval]Welcome,{ENDSHRINK} [@]{WAIT}");
        text.append("{SPIRAL=2;0.5;-2.5}{STYLE=;}[?SHADOW]{VAR=title}[?]{STYLE=;}{ENDSPIRAL}![ ] ");
        text.append("{SPIN=0.5;-1}[+🤔]{ENDSPIN}[ ]{WAIT=0.8}");
        text.append("{FAST}\n\n");
        text.append("{RESET}[@Sans]{MEET}This is{ENDMEET} a [*][MAROON][?SHINY]simple[WHITE][*][?] [#]test[#][@] to {SPIN}show you{ENDSPIN}");
        text.append("{GRADIENT=27C1F5;2776E7;-0.5;5} {CROWD=20;1;forever}how to make text{ENDCROWD} {JUMP}{SLOW}[*][/]fun[/][*] again! ");
        ...
        text.append("{NORMAL}\n\n");
        text.append("[lighter blue violet]{CAROUSEL}Imagine{ENDCAROUSEL}[] the [rich green]{SLAM}[~]bugs[][]!{ENDSLAM} ");
        text.append("I mean, {RAINBOW=1;1;0.7}possibilities{ENDRAINBOW}! ");
