...
public class TypingScalingTest extends ApplicationAdapter {
    Skin        skin;
    Stage       stage;
    SpriteBatch batch;
    TypingLabel label;
...
//                        + " {CROWD}[#BB1100][+skull][#55AA22][+🤡]"
                ...
                "[#]MODES! Error: [?error]oh no[?], Warn: [?warn]uh oh[?], Note: [?note]huh[+]whaaah?[%?], Context: [%?context]yes, interesting[%?], Suggest: [%?suggest]oh, neat[%?]\n" +
                        ...
                        + "@ {NATURAL=1.0}Natural testing: The quick brown fox jumps over the lazy dog.[+"
                ,
//
//                "I love TextraTypist! 😀\n" +
//                "But U. Nitty doesn't. 💀",
...
//        updateDebugLabel();
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new TypingScalingTest(), config);
    }
}
