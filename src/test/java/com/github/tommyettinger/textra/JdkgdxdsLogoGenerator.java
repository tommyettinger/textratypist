...
public class JdkgdxdsLogoGenerator extends ApplicationAdapter {

    private static final String LOGO_NAME = "jdkgdxds";
    ...
    public static void main(String[] args){
        ...
        new Lwjgl3Application(new JdkgdxdsLogoGenerator(), config);
    }
