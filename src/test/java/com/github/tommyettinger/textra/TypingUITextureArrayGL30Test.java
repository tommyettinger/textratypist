 ...
 * <br>
 * Calls: 131, draw calls: 11, shader switches: 1, texture bindings: 1
 */
public class TypingUITextureArrayGL30Test extends InputAdapter implements ApplicationListener {
	...
	public void create () {
		...
		// DistanceFieldType must be STANDARD with TextureArrayGL30Batch
...
//		Batch batch = new SpriteBatch(4000);
		ShaderProgram shader = new ShaderProgram(
				...
				"#version 330 core\n" +
						...
						"}");
		Batch batch = new TextureArrayGL30Batch(1000, 2048, 2048, 8, shader);
...
//		config.setForegroundFPS(Lwjgl3ApplicationConfiguration.getDisplayMode().refreshRate);
		...
		new Lwjgl3Application(new TypingUITextureArrayGL30Test(), config);
	}
