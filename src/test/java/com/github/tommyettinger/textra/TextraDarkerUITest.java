...
//		profiler.enable();
        ...
        ImageTextraButton iconButton = new ImageTextraButton("This is an ImageTextraButton!", style);
        ...
        selectBox.getStyle().font = skin.get("default-font", Font.class);
...
//					profiler.getShaderSwitches(), profiler.getTextureBindings());
	...
	public static void main(String[] args){
		...
		new Lwjgl3Application(new TextraDarkerUITest(), config);
	}
