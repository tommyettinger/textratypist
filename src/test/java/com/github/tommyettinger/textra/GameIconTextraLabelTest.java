...
public class GameIconTextraLabelTest extends ApplicationAdapter {
    Skin        skin;
    Stage       stage;
    SpriteBatch batch;
    TextraLabel label;
...
//                "I love TextraTypist! [@Icons][+keyboard] [gold][+saxophone]{HEARTBEAT}[deep pink][+heart-wings] OMG! [+heart-wings]{ENDHEARTBEAT}[rich apricot][+party-popper][white][@]\n"
...
//                + "\n{RAINBOW}[+pineapple][+raccoon-head][+pterodactylus][+raised-fist][+wolf-howl][+western-hat][@][%]\n"
                ...
                "I love TextraTypist! [@Icons][+keyboard] [gold][+saxophone][deep richer pink][+heart-wings] OMG! [+heart-wings][rich apricot][+party-popper][white][@]\n"
                + "But...[_][+⛎][_]. Nitty doesn't. [+🤮] [@Icons][#BB1100][+broken-skull][#55AA22][+clown][white]\n"
                + "\n[yellow][+pineapple][orange][+raccoon-head][red][+pterodactylus][purple][+raised-fist][blue][+wolf-howl][green][+western-hat][@][%]\n"
...
//        label.parseTokens();
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new GameIconTextraLabelTest(), config);
    }
}
