...
//        label1 = new Label("Test", labelStyle);
        ...
        table.top();
        table.add(group1 = new TransformContainer<>(label1));
        table.add(textraGroup1 = new TransformContainer<>(textraLabel1));
        table.add(typingGroup1 = new TransformContainer<>(typingLabel1)).row();
        table.add(group2 = new TransformContainer<>(label2));
        table.add(textraGroup2 = new TransformContainer<>(textraLabel2));
        table.add(typingGroup2 = new TransformContainer<>(typingLabel2)).row();
        table.add(group3 = new TransformContainer<>(label3));
        table.add(textraGroup3 = new TransformContainer<>(textraLabel3));
        table.add(typingGroup3 = new TransformContainer<>(typingLabel3)).row();
        table.pack();
