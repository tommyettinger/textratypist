...
//		skin = new Skin(Gdx.files.internal("uiskin.json"));
		...
		com.rafaskoberg.gdx.typinglabel.TypingLabel minSizeLabel = new com.rafaskoberg.gdx.typinglabel.TypingLabel("minWidth cell", skin); // demos SplitPane respecting widget's minWidth
...
//		}
//		for (; i < 5; i++) {
//			fpsLabel.getOriginalText().setCharAt(5+i, ' ');
//		}
...
//		config.setForegroundFPS(Lwjgl3ApplicationConfiguration.getDisplayMode().refreshRate);
		...
		new Lwjgl3Application(new RafaTypingUITest(), config);
	}
