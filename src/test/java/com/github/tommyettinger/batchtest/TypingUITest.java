...
package com.github.tommyettinger.batchtest;
...
import com.github.tommyettinger.textra.FreeTypistSkin;
...
import com.github.tommyettinger.batch.TextureArrayCpuPolygonSpriteBatch;
...
public class TypingUITest extends InputAdapter implements ApplicationListener {
	...
	public void create () {
		...
		profiler.disable();
		TextureArrayCpuPolygonSpriteBatch batch = new TextureArrayCpuPolygonSpriteBatch();
